...
export type TActionArgsMap = {
	"add-local-audio": { mediaId: string } | undefined;
	"remove-transition": { trackId: string; elementId: string } | undefined;
	"remove-clip-effect":
		| { trackId: string; elementId: string; effectId: string }
		| undefined;
	"toggle-clip-effect":
		| { trackId: string; elementId: string; effectId: string }
		| undefined;
	"remove-all-clip-effects": { trackId: string; elementId: string } | undefined;
